...
//    @State private var timeRemaining = 3.0
//    @State private var tapSpeed = 1.0
//    @State private var imagePositions: [CGPoint] = Array(repeating: CGPoint(x: 0, y: 0), count: 1)
//
//    
//    let timer = Timer.publish(every: 1, on: .main, in: .common).autoconnect()
//    var imageNames = ["Iklan 1", "Iklan 2", "Iklan 3", "Iklan 4"]
...
//    }
//    
//    private func changeImagesPositions() {
//            for index in 0..<imageNames.count {
//                let newX = CGFloat.random(in: 100...UIScreen.main.bounds.width - 100)
//                let newY = CGFloat.random(in: 100...UIScreen.main.bounds.height - 200)
//                imagePositions[index] = CGPoint(x: newX, y: newY)
//            }
//        }
//        
//        private func changeImage() {
//            imageIndex = (imageIndex + 1) % imageNames.count
//            changeImagesPositions()
//            timeRemaining = 5.0
//        }
//
//    var body: some View {
...
//                                            .foregroundColor(.red)
//                                    }
//                                    .offset(x: CGFloat.random(in: -500...400), y: CGFloat.random(in: -200...70))
//                                    .animation(Animation.easeInOut(duration: 0.2).repeatForever(autoreverses: true))
//                            )
//                        }
//
...
struct GamePlayView: View {
    ...
    @State private var timeRemaining = 3.0
    @State private var tapSpeed = 1.0
    @State private var imagePosition = CGPoint(x: 0, y: 0) // Menggunakan satu CGPoint untuk posisi gambar
    ...
    private func changeImagePosition() {
        let newX = CGFloat.random(in: 100...UIScreen.main.bounds.width - 100)
        let newY = CGFloat.random(in: 100...UIScreen.main.bounds.height - 200)
        imagePosition = CGPoint(x: newX, y: newY)
    }
